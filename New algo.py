...
def optimalpathcover(n,Graph):
    ...
    opc.append(pnum)
    return opc
opc=list(optimalpathcover(n,Graph))
#print(opc)
        ...
        if to_int(q_lmv)<to_int(T_lmv):
            for j in range(len(qlist)):
                ...
                for i in range(len(Tlist)):
                    ...
                    if qlist[j] in Graph[z1] and de[y]<=maxde:
                        nghT.append(z1)
                #print('nghT',nghT)        
                if nghT!=[]:
            ...
            for j in range(len(qlist)):
                ...
                for i in range(len(Tlist)):
                    ...
                    if z in Graph[z1] and de[y]<=maxde:
                        nghT.append(z1)
                #print('nghT',nghT)        
                if nghT!=[]:
                    to=minimumrightend(nghT)
